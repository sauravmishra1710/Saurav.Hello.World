                ...
                <Col md={9}>
                  <div>
                      ...
                      <p>
                        ...
                        <span className="purple">
                          <b>
                            emerging and evolving in my cooking explorations
                          </b>
                        </span>{" "}
                        ...
                        appreciation from friends, and family. And with every
                        such realisation, comes{" "}
                        <span className="purple">
                          <b>
                    ...
                    <p></p>
                      <p>
                        ...
                        keep driving me. Learning new plating skills which is
                        one of my very important aspect as people always eat the
                        food visually first, is it looking good, is it
                        appealing, not appealing. We always enjoy seeing food
                        first as it preceeds consumption. I very well intend to
                        ever{" "}
                        <span className="purple">
                          <b>
                            keep this passion alive and whip up new dishes
                            always
                          </b>
                        </span>
                        .
                ...
                <Col md={9}>
                  <div>
                      ...
                      <p>
                        ...
                        beautiful sceneries, mountains, rivers, valleys excites
                        me in the same way like{" "}
                        <span className="purple">
                          <b>
                            {" "}
                        ...
                        . I guess this hidden passion and intensity for
                        landscape and nature photography comes from{" "}
                        <span className="purple">
                          <b> my father</b>
                        </span>
                        . He was fond of travelling, exploring new places and
                        made sure he always carried his{" "}
                        <span className="purple">
                          <b> Kodak 📸</b>
                        </span>
                        . Capturing all the beautiful landscapes, family
                        pictures and then waiting for the films to get developed
                        days after the vacation.{" "}
                        <span className="purple">
                          <b>
                            {" "}
                      ...
                      <p>
                        ...
                        any kind of conditions and environment. It’s about being
                        at the right place at the right time. Sometimes you get
                      ...
                      <p>
                        ...
                        <span className="purple">
                          <b>
                            it's all a great learning experience with every
                            single picture
                          </b>
                        </span>
                        ...
                        <span className="purple">
                          <b>
                            watch changing position of the sunrise moves
                            northward to southwards across seasons
                          </b>
                        </span>
                        ).{" "}
                        <span className="purple">
